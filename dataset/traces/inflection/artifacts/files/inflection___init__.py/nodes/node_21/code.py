...
def singularize(word: str) -> str:
    for inflection in UNCOUNTABLES:
        if re.fullmatch(re.escape(inflection), word, flags=re.IGNORECASE):
            return word
...
def _init_default_rules() -> None:
    ...
    # Irregulars (prepended with highest precedence)

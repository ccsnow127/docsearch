...
# These globals are expected to be provided by the surrounding environment.
# Do not assign defaults here; allow NameError if missing, per spec.
...
def singularize(word: str) -> str:
    for inflection in UNCOUNTABLES:
        pattern = r"(?i)\b(%s)\Z" % re.escape(inflection)

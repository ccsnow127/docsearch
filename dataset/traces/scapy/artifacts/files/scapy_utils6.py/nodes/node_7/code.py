...
def in6_getLinkScopedMcastAddr(
    ...
    b1 = struct.pack("B", ((0x3 << 4) | scope) & 0xFF)
    a = b"\xff" + b1 + b"\x00" + b"\xff" + iid + b_grpid
...
def rfc3484_cmp(source_a: str, source_b: str, dst: str) -> int:
    if source_a == dst:
        return 1
    if source_b == dst:
        return 1

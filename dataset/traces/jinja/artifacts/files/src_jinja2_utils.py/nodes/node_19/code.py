...
def pass_environment(f: F) -> F:
    """Decorator that marks a callable to receive an Environment as its first argument during rendering."""
...
Cycler.__next__ = Cycler.next  # type: ignore[attr-defined]

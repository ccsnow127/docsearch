...
def select_autoescape(
    ...
    def autoescape(template_name: str | None) -> bool:
        ...
        if enabled_patterns and name.endswith(enabled_patterns):
            return True
        if disabled_patterns and name.endswith(disabled_patterns):
            return False
        return default
...
def autoescape(value: t.Any, enabled: bool = True) -> t.Any:
    if enabled:

...
def pass_environment(f: F) -> F:
    """Decorator that marks a callable to receive a Jinja Environment as its first argument when invoked during template rendering."""
    try:
        from jinja2 import Environment as _JinjaEnvironment  # noqa: F401
    except Exception:
        # Reference attempt should be visible; behavior otherwise is not specified.
        pass
...
@t.cast(t.Any, __import__('collections').abc.MutableMapping).register
class LRUCache:

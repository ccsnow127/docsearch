...
# Project cutoff contract for normalize_timestamp:
# Latest supported instant is 9999-12-31 23:59:59 UTC, expressed as Unix-epoch seconds.
# Seconds-valued inputs near the top end of the supported domain are on the order of 10^11
# and MUST remain classified as seconds.
_MAX_SUPPORTED_UTC = datetime.datetime(9999, 12, 31, 23, 59, 59, tzinfo=datetime.timezone.utc)
MAX_TIMESTAMP: float = _MAX_SUPPORTED_UTC.timestamp()
MAX_TIMESTAMP_MS: float = MAX_TIMESTAMP * 1000
MAX_TIMESTAMP_US: float = MAX_TIMESTAMP * 1_000_000

# Ordinal bounds (Gregorian proleptic) aligned with datetime.date supported range.

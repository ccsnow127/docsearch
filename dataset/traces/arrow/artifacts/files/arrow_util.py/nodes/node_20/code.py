...
# Valid seconds are on the order of 10^11 within this project domain.
_MAX_SUPPORTED_UTC = datetime.datetime(9999, 12, 31, 23, 59, 59, tzinfo=datetime.timezone.utc)
_EPOCH_UTC = datetime.datetime(1970, 1, 1, 0, 0, 0, tzinfo=datetime.timezone.utc)
MAX_TIMESTAMP: float = (_MAX_SUPPORTED_UTC - _EPOCH_UTC).total_seconds()

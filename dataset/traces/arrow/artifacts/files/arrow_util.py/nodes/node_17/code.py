...
# Project domain contract for normalize_timestamp:
# - Latest supported instant: 9999-12-31 23:59:59 UTC
# - MAX_TIMESTAMP is the Unix-epoch seconds value of that instant.
# - Valid seconds are on the order of 10^11.
_MAX_CUTOFF_DT_UTC = datetime.datetime(9999, 12, 31, 23, 59, 59, tzinfo=datetime.timezone.utc)
MAX_TIMESTAMP: int = int(_MAX_CUTOFF_DT_UTC.timestamp())

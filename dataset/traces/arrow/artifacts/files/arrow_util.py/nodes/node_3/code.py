...
# Maximum supported Unix epoch timestamp in seconds.
# Chosen to align with datetime.datetime.max (9999-12-31 23:59:59.999999) in UTC.
_MAX_DT_UTC = datetime.datetime.max.replace(tzinfo=datetime.timezone.utc)
_EPOCH_UTC = datetime.datetime(1970, 1, 1, tzinfo=datetime.timezone.utc)
MAX_TIMESTAMP: float = (_MAX_DT_UTC - _EPOCH_UTC).total_seconds()
MAX_TIMESTAMP_MS: float = MAX_TIMESTAMP * 1000
MAX_TIMESTAMP_US: float = MAX_TIMESTAMP * 1_000_000

# Gregorian ordinal bounds (datetime.date.toordinal()).

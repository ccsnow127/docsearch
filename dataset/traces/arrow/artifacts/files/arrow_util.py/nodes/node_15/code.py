...
# Project contract for normalize_timestamp:
# Latest supported instant (UTC): 2100-01-01 00:00:00+00:00
# Valid seconds are on the order of 10^9 (up to ~4.1e9).
_MAX_CUTOFF_DT_UTC = datetime.datetime(2100, 1, 1, 0, 0, 0, tzinfo=datetime.timezone.utc)

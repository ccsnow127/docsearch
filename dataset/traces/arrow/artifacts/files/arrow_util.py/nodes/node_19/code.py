...
# Valid seconds-valued epoch timestamps in this project are expected to be on the
# order of 1e11 seconds or smaller (i.e., up to year 9999), ensuring clean
# magnitude separation from milliseconds and microseconds within the same domain.
_MAX_CUTOFF_DT_UTC = datetime.datetime(9999, 12, 31, 23, 59, 59, tzinfo=datetime.timezone.utc)
MAX_TIMESTAMP: float = _MAX_CUTOFF_DT_UTC.timestamp()

...
# Project boundary / contract for normalize_timestamp:
# Latest supported instant is explicitly pinned to UTC 9999-12-31 23:59:59.
# This implies valid seconds-valued inputs can reach on the order of 10^11 and
# MUST remain classified as seconds (i.e., 12-digit seconds timestamps are valid).
...
# Ordinal bounds (Gregorian proleptic date range supported by datetime.date)

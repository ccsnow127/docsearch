...
# Latest supported instant (UTC): 9999-12-31 23:59:59
# MAX_TIMESTAMP is the Unix-epoch seconds value for that instant.
_MAX_CUTOFF_DT = datetime.datetime(9999, 12, 31, 23, 59, 59, tzinfo=datetime.timezone.utc)
MAX_TIMESTAMP: int = int(_MAX_CUTOFF_DT.timestamp())
MAX_TIMESTAMP_MS: int = MAX_TIMESTAMP * 1000
MAX_TIMESTAMP_US: int = MAX_TIMESTAMP * 1_000_000

# Gregorian ordinal bounds (inclusive)

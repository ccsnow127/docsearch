...
# Concrete cutoff instant: 9999-12-31 23:59:59 UTC expressed as epoch seconds.
# These constants represent the same cutoff at different resolutions.
...
# Gregorian ordinal bounds.
# Note: The spec requires these to be module-level constants used by validate_ordinal.

...
# Maximum supported instant: 9999-12-31 23:59:59 UTC expressed as Unix epoch seconds.
_MAX_DT_UTC = datetime.datetime(9999, 12, 31, 23, 59, 59, tzinfo=datetime.timezone.utc)
_EPOCH_UTC = datetime.datetime(1970, 1, 1, 0, 0, 0, tzinfo=datetime.timezone.utc)

MAX_TIMESTAMP: int = int((_MAX_DT_UTC - _EPOCH_UTC).total_seconds())
MAX_TIMESTAMP_MS: int = MAX_TIMESTAMP * 1000
MAX_TIMESTAMP_US: int = MAX_TIMESTAMP * 1_000_000

# Gregorian ordinal bounds aligned with datetime.date's supported range.

...
# External modules expected to exist in the runtime environment (per contract)
from osmnx import convert  # type: ignore
from osmnx import projection  # type: ignore
from osmnx import settings  # type: ignore
from osmnx import utils  # type: ignore
...
def _consolidate_subdivide_geometry(geom: Polygon | MultiPolygon) -> MultiPolygon:
    ...
    # Should be unreachable under the contract.

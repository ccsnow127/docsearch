...
# External dependencies expected to exist in the runtime environment
# The original library provides these as sibling modules. In this kata the
# module is imported standalone, so fall back to absolute imports.
try:  # pragma: no cover

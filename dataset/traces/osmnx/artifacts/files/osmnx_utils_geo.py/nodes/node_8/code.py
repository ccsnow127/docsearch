...
try:
    # If this module is part of the `osmnx` package.
    from . import convert, projection, settings, utils  # type: ignore
except Exception:  # pragma: no cover
    # If this module is executed/imported as a standalone file.
...
def _consolidate_subdivide_geometry(geom: Polygon | MultiPolygon) -> MultiPolygon:
    ...
    raise ValueError("Unexpected non-polygonal geometry after consolidation.")
